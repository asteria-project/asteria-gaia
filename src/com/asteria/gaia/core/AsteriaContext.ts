...
export interface AsteriaContext {
     ...
     * 
     * @returns {string} the name of the Asteria session associated with this context.
     */
    getName(): string;
     ...
     * 
     * @returns {string} the unique identifier of the Asteria session associated with this context.
     */
    getId(): string;
     ...
     * 
     * @returns {string} the reference to the stream processor associated with this context.
     */
